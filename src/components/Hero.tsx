...
const Hero = () => {
    ...
    return(
        <main className='border-5 border-red flex w-full max-w-[1200px] m-auto justify-between p-[2em]'>
            <section aria-label='headline' className='border-2 border-red flex flex-col gap-5 items-center justify-center p-1 text-[40px] text-center'>
