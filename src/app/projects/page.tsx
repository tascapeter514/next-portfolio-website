...
const Projects = () => {
    return(
        <section aria-label="projects" className='border-5 border-red flex flex-col w-full max-w-[1200px] m-auto p-[2em] justify-center'>
            <div className='flex flex-col items-center border-1 border-red p-[1em]'>
                <h1 className='text-[40px]'>Projects</h1>
                <Separator className='border-1 border-black max-w-[25%]'/>
            </div>
            <div aria-label='project-cards-container' className='border-3 border-red flex p-[2em]'>
                <article className='border-1 border-lime flex flex-col items-center gap-2 p-[2em]'>
